<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminFAQ.aspx.cs" Inherits="FAQ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 772px">
        ...
        <div style="z-index: 1; left: 62px; top: 105px; position: absolute; height: 653px; width: 853px">
            ...
            style="z-index: 1; left: 597px; top: 14px; position: absolute; height: 20px">Back</asp:LinkButton>
       </div>
</asp:Content>
